...
export class Item extends MyObject3D {
  ...
  protected _update():void {
    ...
    const fixRate = Util.instance.map(s, 0, 1, start, start + sh)
    ...
    item.position.y = Util.instance.mix(sh * 1.5, 0, rate) + this._posNoise.y * itemShakeRange
